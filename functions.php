 ...
 */
    ...
    function capsite_example_setup() {
		...
		wp_enqueue_style('google-fonts-sacramento', '//fonts.googleapis.com/css2?family=Sacramento&display=swap');
		...
		add_action('wp_enqueue_scripts', 'capsite_example_setup');
		...
		////////////////////////////////////////////////////////////////
    	////////         Support for ajax and fetch.js       ///////////
    	//////////////////////////////////////////////////////////////// 


		include 'assets/php/filter-books.php';
